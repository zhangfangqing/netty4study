...
public interface Future<V> extends java.util.concurrent.Future<V> {
	...
	/**
	 * Adds the specified listeners to this future. The specified listeners are
	 * notified when this future is {@linkplain #isDone() done}. If this future
	 * is already completed, the specified listeners are notified immediately.
	 */
	...
	/**
	 * Removes the specified listeners from this future. The specified listeners
	 * are no longer notified when this future is {@linkplain #isDone() done}.
	 * If the specified listeners are not associated with this future, this
	 * method does nothing and returns silently.
	 */
	...
	/**
	 * Return the result without blocking. If the future is not done yet this
