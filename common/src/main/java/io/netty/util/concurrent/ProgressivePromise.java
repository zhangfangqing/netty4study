...
public interface ProgressivePromise<V> extends Promise<V>, ProgressiveFuture<V> {
	...
	/**
	 * Sets the current progress of the operation and notifies the listeners
	 * that implement {@link GenericProgressiveFutureListener}.
	 */
	ProgressivePromise<V> setProgress(long progress, long total);

	/**
	 * Tries to set the current progress of the operation and notifies the
	 * listeners that implement {@link GenericProgressiveFutureListener}. If the
	 * operation is already complete or the progress is out of range, this
	 * method does nothing but returning {@code false}.
	 */
