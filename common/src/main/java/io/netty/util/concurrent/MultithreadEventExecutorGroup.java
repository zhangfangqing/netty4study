...
public abstract class MultithreadEventExecutorGroup extends AbstractEventExecutorGroup {
	 ...
	 *            should be used.
	 * @param args
	 *            arguments which will passed to each
	 *            {@link #newChild(ThreadFactory, Object...)} call
	 */
	 ...
	 * 取出的算法为： 以轮询的方式Math.abs(childIndex.getAndIncrement() %
	 * children.length)算出children数组的一个索引
	 */
	@Override
	...
	/**
	 * Return the number of {@link EventExecutor} this implementation uses. This
	 * number is the maps 1:1 to the threads it use.
	 */
	 ...
	 * {@link #next()} method. This method will be called for each thread that
	 * will serve this {@link MultithreadEventExecutorGroup}.
	 *
	 */
